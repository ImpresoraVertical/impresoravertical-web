...
export const SERIES: Series[] = [
  ...
  // ─────────────────── SERIE T ───────────────────
  {
    ...
    code: "T",
    name: "Serie T",
    tagline: "Tinta UV. Murales hasta 2,7 m.",
    eyebrow: "Serie T · UV · Tall",
    description:
      "Tinta UV de curación instantánea, compatible con prácticamente cualquier superficie incluido vidrio, metacrilato, aluminio. Hasta 2,7 m de altura, ancho infinito y cabezal a escoger según necesidad.",
    inkType: "uv",
    priceFrom: 21500,
    ...
    models: [
      {
        code: "T1",
        name: "T1",
        surface: "Hasta 2,7 m × ancho infinito",
        speed: "Depende de la resolución a imprimir",
        inks: "CMYK + W · UV",
        resolution: "Hasta 2880 dpi",
        printHead: "Cabezal a escoger según necesidad",
        weight: "145 kg",
        highlights: ["Pantalla integrada", "Desplazamiento rueda", "Cabezal a escoger"],
      ...
      },
      {
        ...
        resolution: "Hasta 2880 dpi",
        printHead: "Cabezal a escoger según necesidad",
        highlights: ["Pantalla integrada", "Desplazamiento rail cremallera", "Cabezal a escoger"],
        image: "/modelos/t1.jpg",
      },
    ],
    useCases: [
    ...
    highlights: [
      "Hasta 2,7 m de altura · ancho infinito",
      "Tinta UV multi-superficie (CMYK + W)",
      "Resolución hasta 2880 dpi",
      "Cabezal a escoger según necesidad",
    ],
  },
  ...
  // ─────────────────── SERIE W ───────────────────
  {
    ...
    models: [
      {
        ...
        inks: "UV · CMYK + W + V (Barniz) · 260 ml/color",
    ...
    highlights: [
      ...
      "Tinta UV CMYK + Blanco + Barniz (V) — 260 ml/color",
