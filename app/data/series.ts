...
export const SERIES: Series[] = [
  ...
  // ─────────────────── SERIE W ───────────────────
  {
    ...
    description:
      "Superficie horizontal de hasta 4 metros para murales panorámicos. Doble cabezal opcional para producción industrial. Instalación rápida y sencilla, con maletines de aviación para transporte (W1 nueva generación).",
    inkType: "uv",
    priceFrom: 21500,
    priceLabel: "Desde 21.500€",
    models: [
    ...
    highlights: [
      "Hasta 4,5m de ancho",
      "Instalación rápida y maletines de transporte",
      "WF con doble cabezal y refrigeración líquida",
    ],
  },
